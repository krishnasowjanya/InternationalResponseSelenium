...
public class PFOL019_PortfolioComponentsBasedOnAssetClass extends  ProjectMethods {
	...
	public void validatePortfolioComponentsAssetClassWise() throws InterruptedException {		
		...
		try {
			...
			.getTestDataAsCollection(excelName,"German");
			
			new PriceAndPerformancePage(driver, test)
			.clickAnyFundFromAssetClass(getLocalePropertyValue("lblPpssAssetClaassBalanced"))
			.clickPortfolioTab()
			.verifyPortfolioComponentsForBalanced(data)
