...
public interface WdMethods {
		 ...
		 * 		 * 
		 */
		public void startApp(String browser,String country) ;
		...
		/**
		 * This method will enter the value in the given text field and chose the suggested value
		 * @param ele   - The Webelement (text field) in which the data to be entered
		 * @param data  - The data to be sent to the webelement
		 * @author Babu - TestLeaf
		 * @throws ElementNotVisibleException		 * 
		...
		/**
		 * This method will verify two given text exactly
		...
		/**
		 * This method will verify given element Exist
		 * @param locator   - The locator to identify
		 * @param value		-Locator value
		 * @param elementName - Element name to be displayed in report
		 * @author Mohan
		 */
		...
		/**
		 * This method will retrieve list of web Elements based on given locater
		 * @param locator
		 * @param locator value
		...
		/**
		 * This method will click the given webelement without screen capture
		 * @param WebElement to click
		 */
		public void clickWithNoSnap(WebElement elm);
		
		/**
		 * This method will capture screenshot of full web page
		 * @param Description to display in report
		 */
		public void captureFullScreen(String desc);
		
		/**
		 * This method will return the value for given property from corresponding language dictionary property file
		 * @param PropertyName
		 */
